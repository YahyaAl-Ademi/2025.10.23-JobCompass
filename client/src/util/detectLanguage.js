...
/**
 * Detects whether text is primarily English or Dutch by counting matches
 * against common function words. Use for filtering when job.language is missing.
 * @param {string} description - Job description (e.g. job.normalized_description)
 * @returns {"English"|"Dutch"}
 */

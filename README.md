...
│   │   │   └── [9 more]        # cleanupInProgress, normalizeText, processRapidAPIjob, processScraperJob, validateAllowedFields, validateUserRegistration, validateJob, validatePassword, validationErrorMessage

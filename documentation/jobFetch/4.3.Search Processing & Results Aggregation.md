...
- [Next → Phase 4.4: Server/Network Error Handling](4.4.Server-Network%20Error%20Handling.md)
...
sequenceDiagram
    ...
    participant NeonDB as Neon Database<br/>`search_words`<br/>`jobs`<br/>`search_words_jobs`
